...
# --- Configuration ---
# The stable attractor found in the micro-scan
...
def worker_task(args):
    ...
    # CRITICAL: Sample 't' from the Stability Plateau
...
if __name__ == "__main__":
    ...
    print(f"Target Area: t in [{T_MIN}, {T_MAX}]")
    ...
    # maxtasksperchild cleans up memory leaks
    ...
    print(f"\n\n--- Final Result ---")
    if global_counter:
        winner, count = global_counter.most_common(1)[0]
