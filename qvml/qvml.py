# based on the tn contraction template 
# https://github.com/vm6502q/pyqrack-examples/blob/main/tn_contraction.py
#
# small modifications for iteration speeds (no values) generated by gemini25
