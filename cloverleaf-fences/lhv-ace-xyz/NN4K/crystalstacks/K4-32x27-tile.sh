...
# split 
python3 K4-32x27-tilecp.py --lb 32 --seconds 43200 --workers 24 --log --out proof-sym.json
python3 K4-32x27-tilecp.py --lb 32 --seconds 43200 --workers 24 --no-symmetry --log --out proof-nosym.json
